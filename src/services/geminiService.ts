...
export async function generateSalesScript(lead: Lead): Promise<{ step1: string, step2: string, step3: string }> {
  ...
  const prompt = `
    ...
    4. Idioma: Español.
    5. Formato de salida: JSON con las claves "step1", "step2", "step3". Los valores deben ser cadenas de texto (strings) simples, no objetos.
  `;
